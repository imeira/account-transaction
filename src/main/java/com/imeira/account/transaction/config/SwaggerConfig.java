...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.imeira.account.transaction.controller"))
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder()
                ...
                .version("1.0.0")
                .contact(new Contact("Igor Meira","https://www.linkedin.com/in/imeira/", "meira.igor@gmail.com"))
                .build();
    }
